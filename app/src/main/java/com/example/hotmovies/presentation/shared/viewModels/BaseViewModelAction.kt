...
typealias BaseAsyncViewModelAction<I, O> = BaseViewModelAction<I, ResultState<O>>
typealias BaseAsyncEventViewModelAction<I, O> = BaseViewModelAction<I, Event<ResultState<O>>>