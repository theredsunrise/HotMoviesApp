...
import com.example.hotmovies.shared.async
import com.example.hotmovies.shared.asyncFailure
...
class GlideImageLoader private constructor() : ImageLoaderInterface {
    private var _imageLoadingResultFlow = MutableStateFlow<Async<Any>>(progress)
    ...
    private fun requestListener() = object : RequestListener<Drawable> {
        ...
        override fun onLoadFailed(
            ...
            _imageLoadingResultFlow.tryEmit((e ?: UnknownHostException()).asyncFailure())
            return false
        }
        ...
        override fun onResourceReady(
            ...
            _imageLoadingResultFlow.tryEmit(model.async())
            return false
        }
    }
    ...
    private fun animatedRequestListener(
        ...
        override fun onLoadFailed(
            ...
            context.onLoadState(someException.asyncFailure())
            _imageLoadingResultFlow.tryEmit(someException.asyncFailure())
            return false
        }
        ...
        override fun onResourceReady(
            ...
            context.onLoadState(model.async())
            _imageLoadingResultFlow.tryEmit(model.async())
            return false
        }
    }
